...
input_folder = os.path.expanduser('Your image path here (don"t forget to make sure all slashes are forward slashes, and add one on the end)')
...
file_identifier = 'my file identifier'
